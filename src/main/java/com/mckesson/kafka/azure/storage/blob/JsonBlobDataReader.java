...
public class JsonBlobDataReader extends CloudBlobStorageReader {
  private static final Logger log = LoggerFactory.getLogger(JsonBlobDataReader.class);
